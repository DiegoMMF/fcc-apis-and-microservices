 ...
 * same case (lower or upper case) in order to check for
 * palindromes.
...
function palindrome(str) {
  const extracted = extraerLetras(str);
  const isPalindrome = extracted === extracted.split("").reverse().join("");
  return isPalindrome;
}

console.table(palindrome("Para más información, vea Capítulo 3.4.5.1"));